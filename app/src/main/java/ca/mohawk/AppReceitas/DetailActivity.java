...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (firebaseAuth.getCurrentUser() == null){
            ...
            String atencao = "Você precisa fazer login para acessar essa função.";
            intent.putExtra("Atenção",atencao);
    ...
    public void btnLike(View view) {
        ...
        documentReference.delete()
            ...
            public void onFailure(@NonNull Exception e) {
                Log.d("TAG", " Recipe not deleted from Firestore " + e.getMessage());
                Snackbar.make(findViewById(R.id.txtRecipeName),"Falha ao deletar receita" + e.getMessage(), BaseTransientBottomBar.LENGTH_SHORT).show();
            }
        });
    ...
    public void btnDislike(final View view) {
        ...
        documentReference.set(fireStoreFoodData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Snackbar.make(view,"Falha ao fazer upload da receita" + e.getMessage(), BaseTransientBottomBar.LENGTH_SHORT).show();
            }
        });
