        ...
        documentReference.update("itemName",recipename,"itemDescription",recipeDescription, "itemPrice",recipePrice, "itemImage",imageUrl)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Snackbar. make(findViewById(R.id.txt_recipe_name),"Receita registrada",BaseTransientBottomBar.LENGTH_SHORT).show();
                        finish();
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Snackbar.make(findViewById(R.id.txt_recipe_name),"Falha ao fazer upload da receita" + e.getMessage(), BaseTransientBottomBar.LENGTH_SHORT).show();
            }
        });
