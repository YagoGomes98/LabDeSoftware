...
public class Upload_Recipe extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode == RESULT_OK){
            ...
            Snackbar.make(findViewById(R.id.txt_recipe_name),"Você não escolheu uma imagem", BaseTransientBottomBar.LENGTH_LONG).show();
        }
    }
    ...
    public void uploadImage(final View view){
        ...
        progressDialog.setMessage("Fazendo upload da receita...");
        progressDialog.show();
    ...
    public void btnUploadRecipe(View view) {
        ...
        if(uri == null ){
            Snackbar.make(view,"Faça upload da imagem",Snackbar.LENGTH_LONG).show();
        }
        else if(txt_name.getText().toString().isEmpty()){
            Snackbar.make(view,"Escreva o nome da receita",Snackbar.LENGTH_LONG).show();
        }
        else if(txt_description.getText().toString().isEmpty()){
            Snackbar.make(view,"Escreva a descrição da receita",Snackbar.LENGTH_LONG).show();
        }
        else {
            uploadImage(view);
        }
    ...
    public void uploadRecipe(final View view) {
        ...
        documentReference.set(fireStoreFoodData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Snackbar. make(view,"Receita registrada",BaseTransientBottomBar.LENGTH_SHORT).show();
                finish();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                ...
                Snackbar.make(view,"Falha no upload da receita" + e.getMessage(), BaseTransientBottomBar.LENGTH_SHORT).show();
            }
        });
